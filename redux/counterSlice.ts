...
export const { increment, setGPostNumber, setGStreet, setgNarName, setgOrt, 
    setgVorName, setGCouponCode, setSelectedSearchKeyWords, setBDeliverCountry, 
    setGCannvanisDrive,setGCTKnow, setGCheckedContents,
    setDeliverCountry, setSelectedHerbList, setIsTherapy, setChronic, 
    setAllergiInfo, setRegMedicine, setDetailedSymptom, setSymptoms, decrement, 
    setPageStatus, setEmail, setGender, setMister, setFname, setLname, setBirthday,
     setTphone, setValidationErrors,setSelectedPharmacy, setGAnythingelse,
    setalertAGB, setalertDaten, setalertLCheck1, setalertLCheck2, setGInsurance,
    } = actions;
