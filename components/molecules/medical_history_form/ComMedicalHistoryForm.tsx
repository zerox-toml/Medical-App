...
const ComMedicalHistoryForm = () => {
  return (
    <div className="flex -webkit-flex flex-col mx-auto mt-[2.5rem] gap-[1.875rem] max-[650px]:gap-[16px]">
      <div className="flex -webkit-flex justify-start items-center max-[650px]:flex-col max-[650px]:gap-[18px]">
        <div className="flex -webkit-flex gap-4 w-[50%] justify-start items-start max-[650px]:w-full">
      ...
      <div className="flex -webkit-flex gap-4 justify-start items-start">
