...
const Doctor: React.FC<DoctorProps> = ({ docImg, countryImg, countryname, major, time, isVideo, onClick, isClicked }) => {
    ...
    return (
        <div onClick={onClick} className={`flex -webkit-flex justify-between items-center md:px-[20px] px-[24px] py-[15px] cursor-pointer box-border ${isClicked ? "bg-[rgb(231,226,235)] border-[#41057E]" : "bg-[#ffffff] border-[#ffffff]"} border-[3px]  rounded-[30px] w-full mb-[12px] transition-all`}>
            <div className=' md:flex-row flex -webkit-flex flex-col items-center w-full h-full'>
                <div className=' justify-center items-center flex -webkit-flex md:w-[113px] w-full h-full'>
                ...
                <div className=' flex -webkit-flex flex-col justify-start items-start ml-[20px] h-full md:w-[80%] w-full max-md:mt-[16px]'>
                    ...
                    <div className=' flex -webkit-flex md:flex-row flex-col gap-[4px] justify-start items-start md:mt-[12px] mt-[24px]'>
                        {isVideo &&
                            <div className={`px-[12px] py-[4px] flex -webkit-flex gap-[4px] justify-start items-center ${isClicked ? "bg-[rgb(213,205,220)]" : "bg-[rgb(233,229,237)]"} rounded-[30px]`}>
