      ...
      >
        ...
        >
          ...
          <div className="flex -webkit-flex flex-col gap-3">
            <div className="flex -webkit-flex items-start justify-start gap-1 mt-2">
              <Image
                className="mt-2"
                src={src}
                alt="Bullet"
            ...
            <div className="flex -webkit-flex items-start justify-start gap-1">
              <Image
                className="mt-2"
                src={src}
                alt="Bullet"
      ...
      >
        ...
        >
          ...
          <div className="w-full sm:h-[78px] h-12 mt-[30px]">
            <div className="flex -webkit-flex items-start justify-center py-1 gap-1 bg-[#008E6C12] rounded-[30px] mb-4">
              <Image
                className="mt-2"
                src={greencheck}
                alt="Bullet"
            ...
            <div className="flex -webkit-flex items-start justify-center py-1 gap-1 bg-[#008E6C12] rounded-[30px]">
              <Image
                className="mt-2"
                src={greencheck}
                alt="Bullet"
