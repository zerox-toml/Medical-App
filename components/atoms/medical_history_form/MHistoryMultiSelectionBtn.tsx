...
const MHistoryMultiSelectionBtn: React.FC<MultiSelectTitle> = ({ title, isSelected, onSelect }) => {
  ...
  return (
    <div 
      onClick={handleClick} 
      className={`text-[14px] font-normal w-auto  px-[16px] py-[4px] cursor-pointer flex -webkit-flex justify-center items-center hover:bg-custom-purple hover:opacity-70 rounded-[3.75rem] active:opacity-50
