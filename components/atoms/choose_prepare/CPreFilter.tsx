...
const CPreFilter: React.FC<IFilterProps> = ({ showFilter, setShowFilter }) => {
  ...
  return (
    <div className={`md:hidden flex w-full bg-white rounded-t-[10px] shadow-top-only  relative z-10 justify-center items-center py-2 text-[#41057E] gap-2 cursor-pointer`} onClick={handleClick} >
      Filter
