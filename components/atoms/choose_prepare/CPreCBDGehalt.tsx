  ...
  return (
    <div>
      ...
      <div className="flex gap-1 justify-center">
        <div className="w-[108px] h-[27px] text-base rounded-[20px] bg-[#F5F5F5] py-[2px] px-[10px] text-[#363636] flex justify-start">
          {filterObject.valueMinCBD ?? 1}%
        </div>
        <span className="border-t-2 mt-3 w-[18px] border-t-[#363636]"></span>
        <div className="w-[108px] text-base h-[27px] rounded-[20px] bg-[#F5F5F5] py-[2px] px-[10px] text-[#363636] flex justify-start">
          {filterObject.valueMaxCBD ?? 100}%
        </div>
      </div>
    </div>
